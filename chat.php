            ...
            <div class="col-lg-12">
                <div class="card chat-app">
                    ...
                    <div class="chat">
                        ...
                        <div class="chat-history" style="    height: 366px; overflow-y: scroll">
                            <ul class="m-b-0">
                                <li class="clearfix">
                        ...
                        <div class="chat-message clearfix">
                            <div class="input-group mb-0" style="display: flex;">
                                ...
                                <span class="input-group-text" style="    background: blue; padding: 6px 9px 0 10px; font-size: initial; color: white; text-align: center;">
