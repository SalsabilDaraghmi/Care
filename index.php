                ...
                <div class="care-nav-wrapper">
                    ...
                    <div id="care-menu" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a class="smooth-scroll ref" data-scroll="login" href="#login" onclick="open_pop()">تسجيل
                                    الدخول</a></li>
                            <li><a class="smooth-scroll ref" href="signUp.php">انشاء حساب</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row wow animated bounceInUp" data-wow-duration="2s" data-wow-delay="0.5">
                    ...
                    while ($row = mysqli_fetch_assoc($data)) {
                        $t = $row['name'];
                        $icon = $row['icon'];
                        echo "     <a href=\"#\" onclick=\"open_pop()\" style=\"display: block;text-decoration: none;\">
                    ...
                    <div id="doctors_team" class="owl-carousel owl-theme">
                        ...
                        <div class=\"doctors_member-info text-center\">
                            ...
                            <p class=\"doctors_member-about\">" .
                                    ...
                                    . "</p>
                            <div class=\"about-btn\">
                                <a class=\"btn btn-lg btn-general btn-blue\" href=\"#\" onclick=\"open_pop()\" role=\"button\">تواصل مع الطبيب</a>
                            </div>
                            ...
                            <div class=\"doctors_member-info text-center\">
                                ...
                                <p class=\"doctors_member-about\">" .
                                    ...
                                    . "</p>
                                <div class=\"about-btn\">
                                    <a class=\"btn btn-lg btn-general btn-blue\" href=\"#\" role=\"button\">تواصل مع الطبيب</a>
                                </div>
